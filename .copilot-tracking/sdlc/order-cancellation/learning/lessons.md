...
Owner: Test Engineer
Status: routed
Routed to: hve4isd lessons.md L-024 (dotnet-enterprise instructions, Test Engineer agent)
...
Status: routed
Routed to: hve4isd lessons.md L-024 (Implementation Validator prompt: container-resolution test)
...
Owner: Tech Lead
Status: routed
Routed to: hve4isd lessons.md L-025 (dotnet-enterprise and react-enterprise instructions)
...
Owner: Implementation Validator
Status: routed
Routed to: hve4isd lessons.md L-024 (Implementation Validator prompt: runtime-path trace)
...
Status: routed
Routed to: hve4isd lessons.md L-020 (triage-sarif basenames, scan-artifacts identifier check)
...
Status: routed
Routed to: hve4isd lessons.md L-026 (build-release approval status, doctor version warning)
...
Status: routed
Routed to: hve4isd lessons.md L-022 (onboarding baseline scan)
...
Owner: Overlay Maintainer
Status: routed
Routed to: hve4isd lessons.md L-018, L-019, L-020, L-021 (CI templates, installer .gitignore)
...
Owner: Product Owner
Status: routed
Routed to: https://github.com/alanp-msft/eShop/issues/19
...
Owner: UX Owner
Status: routed
Routed to: https://github.com/alanp-msft/eShop/issues/20
...
Owner: Test Engineer
Status: routed
Routed to: https://github.com/alanp-msft/eShop/issues/21
...
Owner: Tech Lead
Status: routed
Routed to: https://github.com/alanp-msft/eShop/issues/22
...
Owner: SDLC Conductor
Status: routed
Routed to: hve4isd lessons.md L-023 (Conductor and headless recipe open a session per run)
